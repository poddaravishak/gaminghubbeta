...
<head>
 ...
 <script type='text/javascript' src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/0.4.2/sweet-alert.min.js">
 </script>
    ...
    <div class="card border-0">
     ...
     <div class="card-body">
      <form action="pay.php" method="post">
       ...
       <div class="form-group">
        <button type="submit" name="payment" class="btn btn-dark btn-block font-weight-bold"
         onclick="validate()">Proccess</button>
       </div>
      </form>
     </div>
    </div>
