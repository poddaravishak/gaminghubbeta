  ...
  <li class="has_sub">
                            ...
                            <li>
            <a href="/gaminghub/turnament_up.php"><i class="fas fa-home"></i>Turnament admin</a>
          </li>
          <li>
            <a href="./shopuplod.php"><i class="fas fa-user"></i>Store admin panel</a>
          </li>
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br/>admin@gaminghub.com</p>
                    </div>
